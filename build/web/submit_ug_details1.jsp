...
<html>
<head>
  <title>UG Details Submission Status</title>
  <script type="text/javascript">
    function redirectToView() {
      window.location.href = "view_ug_details.jsp";
    }
  </script>
</head>
<body>
  <h2>UG Details Submission Status</h2>
  ...
  <%
    ...
    try {
      ...
      String sql = "INSERT INTO ug_details (username, college_name, degree, completion_year, major_subject, marks, specialization) VALUES (?, ?, ?, ?, ?, ?, ?)";
