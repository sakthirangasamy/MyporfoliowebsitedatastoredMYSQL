...
<body>
  ...
  <%
    ...
    try {
      ...
      // SQL query to select the PG details for the given user
      String sql = "SELECT * FROM pg_details WHERE username = ?";
  ...
  %>
  <p>No PG details found for user: <%= username %></p>
  <%
      }
    } catch (Exception e) {
      e.printStackTrace();
  ...
  %>
   <a href="submit_pg_details.jsp" class="btn btn-primary" style="background-color: black;color: white;position: absolute;top: 400px;left: 800px;">Go Back</a>
