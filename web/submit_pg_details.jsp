...
<body>
  ...
  <div id="container">
    <h2>Submit PG Details</h2>
    <form action="submit_pg_details1.jsp" method="POST">
      <div class="form-row">
      ...
      <div class="form-row">
        <div class="form-column">
          <label for="degree">Degree (e.g., M.Sc, M.Com, M.Tech):</label>
     ...
     <a href="view_pg_details.jsp"> <button id="viewTableBtn" style="background-color: black;color: white;font-weight: bolder;position: absolute;left: 300px;top: 505px;border-radius: 5px;height: 40px;width: 180px">View Table</button></a>
